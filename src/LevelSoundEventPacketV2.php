...
class LevelSoundEventPacketV2 extends DataPacket{
	 ...
	 */
	public static function create(int $sound, \pocketmine\math\Vector3 $position, int $extraData, string $entityType, bool $isBabyMob, bool $disableRelativeVolume) : self{
		$result = new self;
		$result->sound = $sound;
